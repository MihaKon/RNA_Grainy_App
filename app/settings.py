...
JOB_STORAGE_DIR = BASE_DIR.parent / "temp"
...
JOB_MAX_LIFETIME = 24 * SECONDS_PER_HOUR
JOB_CLEANUP_INTERVAL = 15 * SECONDS_PER_MINUTE
JOB_STORAGE_MAX_SIZE = 4 * BYTES_PER_GIB
