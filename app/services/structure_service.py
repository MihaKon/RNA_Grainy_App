...
from app.coarse_grain.parser import CoarseGrainModels, transform_to_coarse_grain, extract_structure_subset
...
class StructureProcessor:
    ...
    def build_comparison_context(
        ...
        display_format = "mmcif" if file_format == SupportedFormats.CIF else SupportedFormats.PDB.value
        ref_filename = f"reference_{filename}"
        coarse_filename = f"coarse_{filename}"
        initial_data = {
            "filename": [ref_filename, coarse_filename],
